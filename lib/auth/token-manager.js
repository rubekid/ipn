...
// token缓存
var tokenCacheKey = global.TOKEN_CACHE || ((global.APP_NAME || '') + '_USER_TOKEN')
...
var TokenManager = {
  ...
  remember: function (loginData) {
    ...
    Storage.set(LOGIN_CACHE_KEY, str.toString())
  },
  /**
   * 忘记账号
   */
  forget: function () {
    Storage.remove(LOGIN_CACHE_KEY)
  },
  /**
   * 自动登录
   */
  autoLogin: function (callback) {
    try {
      ...
      var loginString = Storage.get(LOGIN_CACHE_KEY)
      if (!loginString) {
        return
      }
